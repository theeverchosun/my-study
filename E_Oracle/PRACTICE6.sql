...
DEPT_CD NUMBER CONSTRAINT FK_TE FOREIGN KEY (DEPT_CD) REFERENCES TB_DEPT(DEPT_CD)
);
...
ALTER TABLE TB_EMP MODIFY (EMP_NAME VARCHAR(50));
...
ALTER TABLE TB_EMP ADD CONSTRAINT CT UNIQUE(CONTACT);
